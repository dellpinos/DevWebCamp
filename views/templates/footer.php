<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            <a href="/">
                <h3 class="footer__logo">&#60DevWebCamp/&gt</h3>
            </a>

            <p class="footer__texto">DevWebCamp es un a conferencia para desarrolladores de todos los niveles, se lleva a cabo de forma presencial y en linea.</p>
        </div>
