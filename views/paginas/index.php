        ...
        <?php foreach ($ponentes as $ponente) : ?>
            <div data-aos="<?php aos_animacion(); ?>" class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen Conferencista">
                </picture>
...
<section class="boletos">
    ...
    <div class="boletos__grid">
        <div class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60DevWebCamp/&gt</h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$249</p>
        </div>
        <div class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60DevWebCamp/&gt</h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$69</p>
        </div>
